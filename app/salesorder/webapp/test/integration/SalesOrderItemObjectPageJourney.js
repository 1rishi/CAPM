...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Navigate to SalesOrderItemObjectPageObjectPage", function (Given, When, Then) {
            ...
            Then.onTheSalesOrderHeaderObjectPage.onTable({ property: "itemdetailscomp" }).iCheckRows();
            When.onTheSalesOrderHeaderObjectPage.onTable({ property: "itemdetailscomp" }).iPressRow(0);
