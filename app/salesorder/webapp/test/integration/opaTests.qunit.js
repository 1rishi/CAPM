...
sap.ui.require(
  [
    ...
    "salesorder/test/integration/SalesOrderHeaderListJourney",
    "salesorder/test/integration/SalesOrderHeaderObjectPageJourney",
    "salesorder/test/integration/SalesOrderItemObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
